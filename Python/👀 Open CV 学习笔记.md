...
- [[#五、图像预处理与边缘提取|五、图像预处理与边缘提取]]
  - [[#五、图像预处理与边缘提取#为什么要进行灰度化|1. 为什么要进行灰度化]]
  - [[#五、图像预处理与边缘提取#'组合拳' : 边缘提取与轮廓闭合|2. '组合拳' : 边缘提取与轮廓闭合]]
...
- [[#九、图像平滑与模糊（Smoothing & Blurring）| 九、图像平滑与模糊（Smoothing & Blurring）]]
	...
	- [[#四大模糊算法原理|2. 四大模糊算法原理]]
	- [[#完整的 API 与参数解释|3. 完整的 API 与参数解释]]
	- [[#为什么要模糊、什么时候该用什么时候不该用?|4. 为什么要模糊、什么时候该用什么时候不该用?]]
	- [[#模糊算法在工业级 CV 管道中的核心地位|5. 模糊算法在工业级 CV 管道中的核心地位]]
- [[#十、 图像位运算（Bitwise Operators）| 十、图像位运算（Bitwise Operators）]]
	- [[#四大位运算符逻辑模型|1. 四大位运算符逻辑模型]]
	- [[#图解处理流向|2. 图解处理流向]]
	- [[#完整的 API 与参数详解|3. 完整的 API 与参数详解]]
	- [[#为什么要使用它?|4. 为什么要使用它?]]
...
- [[#十二、图像直方图计算与可视化（Histograms Computation & Visualization）|十二、图像直方图计算与可视化]]
	...
	- [[#十二、图像直方图计算与可视化（Histograms Computation & Visualization）#完整的 API 与参数详解|3. 完整的 API 与参数详解]]
	- [[#为什么要用它？|4. 为什么要用它？]]
	- [[#学术与工程疑难：画“直方图”为什么用的是“折线图 (plt.plot)”而不是“柱状图 (plt.hist)”？|5. 学术疑难：为什么用折线图而不是柱状图？]]
	- [[#什么时候使用直方图分析?|6. 什么时候使用直方图分析？]]
	- [[#图像直方图计算与可视化 在大型复杂系统/具身机器人管道中的地位|7. 在大型复杂系统/具身机器人管道中的地位]]
- [[#十三、图像阈值化与二值化（Thresholding / Binarization）|十三、图像阈值化与二值化]]
	- [[#什么是简单全局阈值化(Simple Thresholding)|1. 什么是简单全局阈值化 (Simple Thresholding)]]
	- [[#核心概念对比：简单阈值化 vs 自适应均值滤波 vs 自适应高斯滤波|2. 核心概念对比：简单 vs 自适应均值 vs 自适应高斯]]
	- [[#系统架构与数据流/处理图解|3. 系统架构与数据流/处理图解]]
	- [[#完整的 API 与参数详解|4. 完整的 API 与参数详解]]
	- [[#为什么要用它?|5. 为什么要用它?]]
	- [[#什么时候该用?|6. 什么时候该用?]]
	- [[#方案在大型复杂系统/具身机器人管道中的地位|7. 在大型复杂系统/具身机器人管道中的地位]]
- [[#十四、图像梯度与边缘检测（Gradients & Edge Detection）|十四、图像梯度与边缘检测（Gradients & Edge Detection）]]
	- [[#核心概念与底层物理/数学逻辑模型|1. 核心概念与底层物理/数学逻辑模型]]
	- [[#完整 API 与 参数详解|2. 完整 API 与 参数详解]]
	- [[#为什么要用它?|3. 为什么要用它?]]
	- [[#什么时候使用微分梯度?|4. 什么时候使用微分梯度?]]
	- [[#方案在大型复杂系统/具身机器人管道中的地位|5. 在大型复杂系统/具身机器人管道中的地位]]
...
![](附件/excalidraw/位运算叠层与结果网格组合方案.png)
...
### 图像直方图计算与可视化 在大型复杂系统/具身机器人管道中的地位
